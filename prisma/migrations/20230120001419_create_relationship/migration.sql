...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_habbit_id_fkey" FOREIGN KEY ("habbit_id") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_day_habits" ("day_id", "habbit_id", "id") SELECT "day_id", "habbit_id", "id" FROM "day_habits";
